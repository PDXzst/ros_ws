...
(cl:defclass <LinktrackNodeframe0> (roslisp-msg-protocol:ros-message)
  ((role
   ...
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector imu_single_uwb-msg:LinktrackNode0)
   :initform (cl:make-array 0 :element-type 'imu_single_uwb-msg:LinktrackNode0 :initial-element (cl:make-instance 'imu_single_uwb-msg:LinktrackNode0))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNodeframe0>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNodeframe0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackNodeframe0> is deprecated: use imu_single_uwb-msg:LinktrackNodeframe0 instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackNodeframe0>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'imu_single_uwb-msg:LinktrackNode0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackNodeframe0>)))
  ...
  "imu_single_uwb/LinktrackNodeframe0")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackNodeframe0)))
  "Returns string type for a message object of type 'LinktrackNodeframe0"
  "imu_single_uwb/LinktrackNodeframe0")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackNodeframe0>)))
  ...
  (cl:format cl:nil "uint8 role~%uint8 id~%LinktrackNode0[] nodes~%~%================================================================================~%MSG: imu_single_uwb/LinktrackNode0~%uint8 role~%uint8 id~%uint8[] data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackNodeframe0)))
  "Returns full string definition for message of type 'LinktrackNodeframe0"
  (cl:format cl:nil "uint8 role~%uint8 id~%LinktrackNode0[] nodes~%~%================================================================================~%MSG: imu_single_uwb/LinktrackNode0~%uint8 role~%uint8 id~%uint8[] data~%~%~%"))
