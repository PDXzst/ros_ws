...
(cl:defclass <LinktrackAnchorframe0> (roslisp-msg-protocol:ros-message)
  ((role
   ...
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector imu_single_uwb-msg:LinktrackTag)
   :initform (cl:make-array 0 :element-type 'imu_single_uwb-msg:LinktrackTag :initial-element (cl:make-instance 'imu_single_uwb-msg:LinktrackTag))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackAnchorframe0>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackAnchorframe0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackAnchorframe0> is deprecated: use imu_single_uwb-msg:LinktrackAnchorframe0 instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackAnchorframe0>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'imu_single_uwb-msg:LinktrackTag))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackAnchorframe0>)))
  ...
  "imu_single_uwb/LinktrackAnchorframe0")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackAnchorframe0)))
  "Returns string type for a message object of type 'LinktrackAnchorframe0"
  "imu_single_uwb/LinktrackAnchorframe0")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackAnchorframe0>)))
  ...
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackTag[] nodes~%~%================================================================================~%MSG: imu_single_uwb/LinktrackTag~%uint8 role~%uint8 id~%float32[3] pos_3d~%float32[8] dis_arr~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackAnchorframe0)))
  "Returns full string definition for message of type 'LinktrackAnchorframe0"
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackTag[] nodes~%~%================================================================================~%MSG: imu_single_uwb/LinktrackTag~%uint8 role~%uint8 id~%float32[3] pos_3d~%float32[8] dis_arr~%~%~%"))
