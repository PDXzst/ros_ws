...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackTag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackTag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackTag> is deprecated: use imu_single_uwb-msg:LinktrackTag instead.")))
