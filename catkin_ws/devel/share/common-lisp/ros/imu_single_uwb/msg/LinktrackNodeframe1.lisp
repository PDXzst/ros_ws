...
(cl:defclass <LinktrackNodeframe1> (roslisp-msg-protocol:ros-message)
  ((role
   ...
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector imu_single_uwb-msg:LinktrackNode1)
   :initform (cl:make-array 0 :element-type 'imu_single_uwb-msg:LinktrackNode1 :initial-element (cl:make-instance 'imu_single_uwb-msg:LinktrackNode1))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNodeframe1>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNodeframe1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackNodeframe1> is deprecated: use imu_single_uwb-msg:LinktrackNodeframe1 instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackNodeframe1>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'imu_single_uwb-msg:LinktrackNode1))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackNodeframe1>)))
  ...
  "imu_single_uwb/LinktrackNodeframe1")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackNodeframe1)))
  "Returns string type for a message object of type 'LinktrackNodeframe1"
  "imu_single_uwb/LinktrackNodeframe1")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackNodeframe1>)))
  ...
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackNode1[] nodes~%~%================================================================================~%MSG: imu_single_uwb/LinktrackNode1~%uint8 role~%uint8 id~%float32[3] pos_3d~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackNodeframe1)))
  "Returns full string definition for message of type 'LinktrackNodeframe1"
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackNode1[] nodes~%~%================================================================================~%MSG: imu_single_uwb/LinktrackNode1~%uint8 role~%uint8 id~%float32[3] pos_3d~%~%~%"))
