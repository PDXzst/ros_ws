...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNode1>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNode1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackNode1> is deprecated: use imu_single_uwb-msg:LinktrackNode1 instead.")))
