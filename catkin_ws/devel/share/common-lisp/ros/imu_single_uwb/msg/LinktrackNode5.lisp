...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNode5>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNode5)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackNode5> is deprecated: use imu_single_uwb-msg:LinktrackNode5 instead.")))
