...
(cl:defclass <LinktrackNode4Tag> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (anchors
    :reader anchors
    :initarg :anchors
    :type (cl:vector imu_single_uwb-msg:LinktrackNode4Anchor)
   :initform (cl:make-array 0 :element-type 'imu_single_uwb-msg:LinktrackNode4Anchor :initial-element (cl:make-instance 'imu_single_uwb-msg:LinktrackNode4Anchor))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNode4Tag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNode4Tag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackNode4Tag> is deprecated: use imu_single_uwb-msg:LinktrackNode4Tag instead.")))
...
(cl:defmethod anchors-val ((m <LinktrackNode4Tag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_single_uwb-msg:anchors-val is deprecated.  Use imu_single_uwb-msg:anchors instead.")
  (anchors m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackNode4Tag>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'anchors)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'imu_single_uwb-msg:LinktrackNode4Anchor))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackNode4Tag>)))
  ...
  "imu_single_uwb/LinktrackNode4Tag")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackNode4Tag)))
  "Returns string type for a message object of type 'LinktrackNode4Tag"
  "imu_single_uwb/LinktrackNode4Tag")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackNode4Tag>)))
  ...
  (cl:format cl:nil "uint8 id~%float32 voltage~%LinktrackNode4Anchor[] anchors~%~%================================================================================~%MSG: imu_single_uwb/LinktrackNode4Anchor~%uint8 id~%float32 dis~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackNode4Tag)))
  "Returns full string definition for message of type 'LinktrackNode4Tag"
  (cl:format cl:nil "uint8 id~%float32 voltage~%LinktrackNode4Anchor[] anchors~%~%================================================================================~%MSG: imu_single_uwb/LinktrackNode4Anchor~%uint8 id~%float32 dis~%~%~%"))
