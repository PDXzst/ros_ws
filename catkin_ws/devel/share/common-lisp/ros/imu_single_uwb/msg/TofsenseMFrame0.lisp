...
(cl:defclass <TofsenseMFrame0> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (pixels
    :reader pixels
    :initarg :pixels
    :type (cl:vector imu_single_uwb-msg:TofsenseMFrame0Pixel)
   :initform (cl:make-array 0 :element-type 'imu_single_uwb-msg:TofsenseMFrame0Pixel :initial-element (cl:make-instance 'imu_single_uwb-msg:TofsenseMFrame0Pixel))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TofsenseMFrame0>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TofsenseMFrame0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<TofsenseMFrame0> is deprecated: use imu_single_uwb-msg:TofsenseMFrame0 instead.")))
...
(cl:defmethod pixel_count-val ((m <TofsenseMFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_single_uwb-msg:pixel_count-val is deprecated.  Use imu_single_uwb-msg:pixel_count instead.")
  (pixel_count m))

(cl:ensure-generic-function 'pixels-val :lambda-list '(m))
(cl:defmethod pixels-val ((m <TofsenseMFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_single_uwb-msg:pixels-val is deprecated.  Use imu_single_uwb-msg:pixels instead.")
  (pixels m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TofsenseMFrame0>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'pixels)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'imu_single_uwb-msg:TofsenseMFrame0Pixel))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TofsenseMFrame0>)))
  ...
  "imu_single_uwb/TofsenseMFrame0")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TofsenseMFrame0)))
  "Returns string type for a message object of type 'TofsenseMFrame0"
  "imu_single_uwb/TofsenseMFrame0")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TofsenseMFrame0>)))
  ...
  (cl:format cl:nil "uint8 id~%uint32 system_time~%uint8 pixel_count~%TofsenseMFrame0Pixel[] pixels~%~%================================================================================~%MSG: imu_single_uwb/TofsenseMFrame0Pixel~%float32 dis~%uint8 dis_status~%uint16 signal_strength~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TofsenseMFrame0)))
  "Returns full string definition for message of type 'TofsenseMFrame0"
  (cl:format cl:nil "uint8 id~%uint32 system_time~%uint8 pixel_count~%TofsenseMFrame0Pixel[] pixels~%~%================================================================================~%MSG: imu_single_uwb/TofsenseMFrame0Pixel~%float32 dis~%uint8 dis_status~%uint16 signal_strength~%~%~%"))
