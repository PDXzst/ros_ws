...
(cl:defclass <IotFrame0> (roslisp-msg-protocol:ros-message)
  ((uid
   ...
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector imu_single_uwb-msg:IotFrame0Node)
   :initform (cl:make-array 0 :element-type 'imu_single_uwb-msg:IotFrame0Node :initial-element (cl:make-instance 'imu_single_uwb-msg:IotFrame0Node))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <IotFrame0>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IotFrame0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<IotFrame0> is deprecated: use imu_single_uwb-msg:IotFrame0 instead.")))

(cl:ensure-generic-function 'uid-val :lambda-list '(m))
(cl:defmethod uid-val ((m <IotFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_single_uwb-msg:uid-val is deprecated.  Use imu_single_uwb-msg:uid instead.")
  (uid m))
...
(cl:defmethod io_status-val ((m <IotFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_single_uwb-msg:io_status-val is deprecated.  Use imu_single_uwb-msg:io_status instead.")
  (io_status m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <IotFrame0>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'imu_single_uwb-msg:IotFrame0Node))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IotFrame0>)))
  ...
  (cl:format cl:nil "uint32 uid~%uint32 system_time~%uint8 io_status~%IotFrame0Node[] nodes~%~%================================================================================~%MSG: imu_single_uwb/IotFrame0Node~%uint32 uid~%float32 dis~%float32 aoa_angle_horizontal~%float32 aoa_angle_vertical~%float32 fp_rssi~%float32 rx_rssi~%string user_data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IotFrame0)))
  "Returns full string definition for message of type 'IotFrame0"
  (cl:format cl:nil "uint32 uid~%uint32 system_time~%uint8 io_status~%IotFrame0Node[] nodes~%~%================================================================================~%MSG: imu_single_uwb/IotFrame0Node~%uint32 uid~%float32 dis~%float32 aoa_angle_horizontal~%float32 aoa_angle_vertical~%float32 fp_rssi~%float32 rx_rssi~%string user_data~%~%~%"))
