...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNodeframe3>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNodeframe3)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackNodeframe3> is deprecated: use imu_single_uwb-msg:LinktrackNodeframe3 instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackNodeframe3>)))
  ...
  "imu_single_uwb/LinktrackNodeframe3")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackNodeframe3)))
  "Returns string type for a message object of type 'LinktrackNodeframe3"
  "imu_single_uwb/LinktrackNodeframe3")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackNodeframe3>)))
  ...
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackNode2[] nodes~%~%================================================================================~%MSG: imu_single_uwb/LinktrackNode2~%uint8 role~%uint8 id~%float32 dis~%float32 fp_rssi~%float32 rx_rssi~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackNodeframe3)))
  "Returns full string definition for message of type 'LinktrackNodeframe3"
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackNode2[] nodes~%~%================================================================================~%MSG: imu_single_uwb/LinktrackNode2~%uint8 role~%uint8 id~%float32 dis~%float32 fp_rssi~%float32 rx_rssi~%~%~%"))
