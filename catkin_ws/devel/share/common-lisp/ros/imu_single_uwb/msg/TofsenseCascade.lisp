...
(cl:defclass <TofsenseCascade> (roslisp-msg-protocol:ros-message)
  ((nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector imu_single_uwb-msg:TofsenseFrame0)
   :initform (cl:make-array 0 :element-type 'imu_single_uwb-msg:TofsenseFrame0 :initial-element (cl:make-instance 'imu_single_uwb-msg:TofsenseFrame0))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TofsenseCascade>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TofsenseCascade)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<TofsenseCascade> is deprecated: use imu_single_uwb-msg:TofsenseCascade instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TofsenseCascade>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'imu_single_uwb-msg:TofsenseFrame0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TofsenseCascade>)))
  ...
  "imu_single_uwb/TofsenseCascade")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TofsenseCascade)))
  "Returns string type for a message object of type 'TofsenseCascade"
  "imu_single_uwb/TofsenseCascade")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TofsenseCascade>)))
  ...
  (cl:format cl:nil "TofsenseFrame0[] nodes~%~%================================================================================~%MSG: imu_single_uwb/TofsenseFrame0~%uint8 id~%uint32 system_time~%float32 dis~%uint8 dis_status~%uint16 signal_strength~%uint8 range_precision~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TofsenseCascade)))
  "Returns full string definition for message of type 'TofsenseCascade"
  (cl:format cl:nil "TofsenseFrame0[] nodes~%~%================================================================================~%MSG: imu_single_uwb/TofsenseFrame0~%uint8 id~%uint32 system_time~%float32 dis~%uint8 dis_status~%uint16 signal_strength~%uint8 range_precision~%~%~%"))
