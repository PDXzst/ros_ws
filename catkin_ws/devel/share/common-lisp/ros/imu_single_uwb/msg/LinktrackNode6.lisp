...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNode6>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNode6)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackNode6> is deprecated: use imu_single_uwb-msg:LinktrackNode6 instead.")))
