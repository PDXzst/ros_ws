...
(cl:defclass <LinktrackNodeframe6> (roslisp-msg-protocol:ros-message)
  ((role
   ...
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector imu_single_uwb-msg:LinktrackNode6)
   :initform (cl:make-array 0 :element-type 'imu_single_uwb-msg:LinktrackNode6 :initial-element (cl:make-instance 'imu_single_uwb-msg:LinktrackNode6))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNodeframe6>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNodeframe6)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackNodeframe6> is deprecated: use imu_single_uwb-msg:LinktrackNodeframe6 instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackNodeframe6>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'imu_single_uwb-msg:LinktrackNode6))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackNodeframe6>)))
  ...
  "imu_single_uwb/LinktrackNodeframe6")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackNodeframe6)))
  "Returns string type for a message object of type 'LinktrackNodeframe6"
  "imu_single_uwb/LinktrackNodeframe6")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackNodeframe6>)))
  ...
  (cl:format cl:nil "uint8 role~%uint32 id~%LinktrackNode6[] nodes~%~%================================================================================~%MSG: imu_single_uwb/LinktrackNode6~%uint8 role~%uint32 id~%uint8[] data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackNodeframe6)))
  "Returns full string definition for message of type 'LinktrackNodeframe6"
  (cl:format cl:nil "uint8 role~%uint32 id~%LinktrackNode6[] nodes~%~%================================================================================~%MSG: imu_single_uwb/LinktrackNode6~%uint8 role~%uint32 id~%uint8[] data~%~%~%"))
