...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNode2>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNode2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_single_uwb-msg:<LinktrackNode2> is deprecated: use imu_single_uwb-msg:LinktrackNode2 instead.")))
