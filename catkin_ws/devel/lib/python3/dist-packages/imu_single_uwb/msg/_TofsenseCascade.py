...
"""autogenerated by genpy from imu_single_uwb/TofsenseCascade.msg. Do not edit."""
import codecs
import sys
...
class TofsenseCascade(genpy.Message):
  ...
  _type = "imu_single_uwb/TofsenseCascade"
...
"""
  __slots__ = ['nodes']
  _slot_types = ['imu_single_uwb/TofsenseFrame0[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_single_uwb.msg.TofsenseFrame0()
        _x = val1
        start = end
        end += 13
