...
"""autogenerated by genpy from imu_single_uwb/LinktrackNodeframe4.msg. Do not edit."""
import codecs
import sys
...
class LinktrackNodeframe4(genpy.Message):
  ...
  _type = "imu_single_uwb/LinktrackNodeframe4"
...
"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','imu_single_uwb/LinktrackNode4Tag[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_single_uwb.msg.LinktrackNode4Tag()
        _x = val1
        start = end
        end += 5
        ...
        val1.anchors = []
        for i in range(0, length):
          val2 = imu_single_uwb.msg.LinktrackNode4Anchor()
          _x = val2
          start = end
          end += 5
