...
"""autogenerated by genpy from imu_single_uwb/LinktrackNode4Tag.msg. Do not edit."""
import codecs
import sys
...
class LinktrackNode4Tag(genpy.Message):
  ...
  _type = "imu_single_uwb/LinktrackNode4Tag"
...
"""
  ...
  _slot_types = ['uint8','float32','imu_single_uwb/LinktrackNode4Anchor[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_single_uwb.msg.LinktrackNode4Anchor()
        _x = val1
        start = end
        end += 5
