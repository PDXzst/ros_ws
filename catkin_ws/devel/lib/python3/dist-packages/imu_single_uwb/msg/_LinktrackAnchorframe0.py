...
"""autogenerated by genpy from imu_single_uwb/LinktrackAnchorframe0.msg. Do not edit."""
import codecs
import sys
...
class LinktrackAnchorframe0(genpy.Message):
  ...
  _type = "imu_single_uwb/LinktrackAnchorframe0"
...
"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','imu_single_uwb/LinktrackTag[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_single_uwb.msg.LinktrackTag()
        _x = val1
        start = end
        end += 2
