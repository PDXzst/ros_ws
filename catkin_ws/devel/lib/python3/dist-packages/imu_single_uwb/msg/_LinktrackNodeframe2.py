...
"""autogenerated by genpy from imu_single_uwb/LinktrackNodeframe2.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','float32[3]','float32[3]','float32[3]','float32[3]','float32[4]','float32[3]','float32[3]','imu_single_uwb/LinktrackNode2[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_single_uwb.msg.LinktrackNode2()
        _x = val1
        start = end
        end += 14
