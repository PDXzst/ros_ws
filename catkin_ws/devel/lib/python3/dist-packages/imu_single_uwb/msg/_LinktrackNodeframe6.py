...
"""autogenerated by genpy from imu_single_uwb/LinktrackNodeframe6.msg. Do not edit."""
import codecs
import sys
...
class LinktrackNodeframe6(genpy.Message):
  ...
  _type = "imu_single_uwb/LinktrackNodeframe6"
...
"""
  ...
  _slot_types = ['uint8','uint32','imu_single_uwb/LinktrackNode6[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_single_uwb.msg.LinktrackNode6()
        _x = val1
        start = end
        end += 5
        (_x.role, _x.id,) = _get_struct_BI().unpack(str[start:end])
