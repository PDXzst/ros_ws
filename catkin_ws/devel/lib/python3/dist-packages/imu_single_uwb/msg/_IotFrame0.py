...
"""autogenerated by genpy from imu_single_uwb/IotFrame0.msg. Do not edit."""
import codecs
import sys
...
class IotFrame0(genpy.Message):
  ...
  _type = "imu_single_uwb/IotFrame0"
...
"""
  ...
  _slot_types = ['uint32','uint32','uint8','imu_single_uwb/IotFrame0Node[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_single_uwb.msg.IotFrame0Node()
        _x = val1
        start = end
        end += 24
