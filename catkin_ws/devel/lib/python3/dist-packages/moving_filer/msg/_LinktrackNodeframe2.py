...
"""autogenerated by genpy from moving_filer/LinktrackNodeframe2.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','float32[3]','float32[3]','float32[3]','float32[3]','float32[4]','float32[3]','float32[3]','moving_filer/LinktrackNode2[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = moving_filer.msg.LinktrackNode2()
        _x = val1
        start = end
        end += 14
