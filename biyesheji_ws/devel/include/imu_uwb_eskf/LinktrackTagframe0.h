// Generated by gencpp from file imu_uwb_eskf/LinktrackTagframe0.msg
// DO NOT EDIT!


#ifndef IMU_UWB_ESKF_MESSAGE_LINKTRACKTAGFRAME0_H
#define IMU_UWB_ESKF_MESSAGE_LINKTRACKTAGFRAME0_H
...
struct LinktrackTagframe0_
{
  ...
  typedef boost::shared_ptr< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> const> ConstPtr;

}; // struct LinktrackTagframe0_

typedef ::imu_uwb_eskf::LinktrackTagframe0_<std::allocator<void> > LinktrackTagframe0;

typedef boost::shared_ptr< ::imu_uwb_eskf::LinktrackTagframe0 > LinktrackTagframe0Ptr;
typedef boost::shared_ptr< ::imu_uwb_eskf::LinktrackTagframe0 const> LinktrackTagframe0ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator1> & lhs, const ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> >
{
  ...
  static const char* value(const ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x20cc09884b3e1aa8ULL;
  static const uint64_t static_value2 = 0x30a1d8a71796a857ULL;
};

template<class ContainerAllocator>
struct DataType< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> >
{
  static const char* value()
  {
    return "uint8 role\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::imu_uwb_eskf::LinktrackTagframe0_<ContainerAllocator>& v)
  {
    s << indent << "role: ";
...
#endif // IMU_UWB_ESKF_MESSAGE_LINKTRACKTAGFRAME0_H
