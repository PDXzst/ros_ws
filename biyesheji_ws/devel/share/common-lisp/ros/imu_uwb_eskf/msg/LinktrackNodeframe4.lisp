...
(cl:defclass <LinktrackNodeframe4> (roslisp-msg-protocol:ros-message)
  ((role
   ...
   (tags
    :reader tags
    :initarg :tags
    :type (cl:vector imu_uwb_eskf-msg:LinktrackNode4Tag)
   :initform (cl:make-array 0 :element-type 'imu_uwb_eskf-msg:LinktrackNode4Tag :initial-element (cl:make-instance 'imu_uwb_eskf-msg:LinktrackNode4Tag))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNodeframe4>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNodeframe4)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_uwb_eskf-msg:<LinktrackNodeframe4> is deprecated: use imu_uwb_eskf-msg:LinktrackNodeframe4 instead.")))
...
(cl:defmethod tags-val ((m <LinktrackNodeframe4>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:tags-val is deprecated.  Use imu_uwb_eskf-msg:tags instead.")
  (tags m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackNodeframe4>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tags)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'imu_uwb_eskf-msg:LinktrackNode4Tag))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackNodeframe4>)))
  ...
  "imu_uwb_eskf/LinktrackNodeframe4")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackNodeframe4)))
  "Returns string type for a message object of type 'LinktrackNodeframe4"
  "imu_uwb_eskf/LinktrackNodeframe4")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackNodeframe4>)))
  ...
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackNode4Tag[] tags~%~%================================================================================~%MSG: imu_uwb_eskf/LinktrackNode4Tag~%uint8 id~%float32 voltage~%LinktrackNode4Anchor[] anchors~%~%================================================================================~%MSG: imu_uwb_eskf/LinktrackNode4Anchor~%uint8 id~%float32 dis~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackNodeframe4)))
  "Returns full string definition for message of type 'LinktrackNodeframe4"
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackNode4Tag[] tags~%~%================================================================================~%MSG: imu_uwb_eskf/LinktrackNode4Tag~%uint8 id~%float32 voltage~%LinktrackNode4Anchor[] anchors~%~%================================================================================~%MSG: imu_uwb_eskf/LinktrackNode4Anchor~%uint8 id~%float32 dis~%~%~%"))
