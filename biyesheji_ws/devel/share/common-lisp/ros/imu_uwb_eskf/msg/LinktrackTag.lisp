...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackTag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackTag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_uwb_eskf-msg:<LinktrackTag> is deprecated: use imu_uwb_eskf-msg:LinktrackTag instead.")))
