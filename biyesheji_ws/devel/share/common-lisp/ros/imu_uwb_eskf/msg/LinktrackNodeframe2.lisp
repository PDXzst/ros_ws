...
(cl:defclass <LinktrackNodeframe2> (roslisp-msg-protocol:ros-message)
  ((role
   ...
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector imu_uwb_eskf-msg:LinktrackNode2)
   :initform (cl:make-array 0 :element-type 'imu_uwb_eskf-msg:LinktrackNode2 :initial-element (cl:make-instance 'imu_uwb_eskf-msg:LinktrackNode2))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNodeframe2>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNodeframe2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_uwb_eskf-msg:<LinktrackNodeframe2> is deprecated: use imu_uwb_eskf-msg:LinktrackNodeframe2 instead.")))

(cl:ensure-generic-function 'role-val :lambda-list '(m))
(cl:defmethod role-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:role-val is deprecated.  Use imu_uwb_eskf-msg:role instead.")
  (role m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:id-val is deprecated.  Use imu_uwb_eskf-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'local_time-val :lambda-list '(m))
(cl:defmethod local_time-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:local_time-val is deprecated.  Use imu_uwb_eskf-msg:local_time instead.")
  (local_time m))

(cl:ensure-generic-function 'system_time-val :lambda-list '(m))
(cl:defmethod system_time-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:system_time-val is deprecated.  Use imu_uwb_eskf-msg:system_time instead.")
  (system_time m))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:voltage-val is deprecated.  Use imu_uwb_eskf-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'pos_3d-val :lambda-list '(m))
(cl:defmethod pos_3d-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:pos_3d-val is deprecated.  Use imu_uwb_eskf-msg:pos_3d instead.")
  (pos_3d m))

(cl:ensure-generic-function 'eop_3d-val :lambda-list '(m))
(cl:defmethod eop_3d-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:eop_3d-val is deprecated.  Use imu_uwb_eskf-msg:eop_3d instead.")
  (eop_3d m))

(cl:ensure-generic-function 'vel_3d-val :lambda-list '(m))
(cl:defmethod vel_3d-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:vel_3d-val is deprecated.  Use imu_uwb_eskf-msg:vel_3d instead.")
  (vel_3d m))

(cl:ensure-generic-function 'angle_3d-val :lambda-list '(m))
(cl:defmethod angle_3d-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:angle_3d-val is deprecated.  Use imu_uwb_eskf-msg:angle_3d instead.")
  (angle_3d m))

(cl:ensure-generic-function 'quaternion-val :lambda-list '(m))
(cl:defmethod quaternion-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:quaternion-val is deprecated.  Use imu_uwb_eskf-msg:quaternion instead.")
  (quaternion m))

(cl:ensure-generic-function 'imu_gyro_3d-val :lambda-list '(m))
(cl:defmethod imu_gyro_3d-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:imu_gyro_3d-val is deprecated.  Use imu_uwb_eskf-msg:imu_gyro_3d instead.")
  (imu_gyro_3d m))

(cl:ensure-generic-function 'imu_acc_3d-val :lambda-list '(m))
(cl:defmethod imu_acc_3d-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:imu_acc_3d-val is deprecated.  Use imu_uwb_eskf-msg:imu_acc_3d instead.")
  (imu_acc_3d m))

(cl:ensure-generic-function 'nodes-val :lambda-list '(m))
(cl:defmethod nodes-val ((m <LinktrackNodeframe2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:nodes-val is deprecated.  Use imu_uwb_eskf-msg:nodes instead.")
  (nodes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackNodeframe2>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'imu_uwb_eskf-msg:LinktrackNode2))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackNodeframe2>)))
  ...
  "imu_uwb_eskf/LinktrackNodeframe2")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackNodeframe2)))
  "Returns string type for a message object of type 'LinktrackNodeframe2"
  "imu_uwb_eskf/LinktrackNodeframe2")
