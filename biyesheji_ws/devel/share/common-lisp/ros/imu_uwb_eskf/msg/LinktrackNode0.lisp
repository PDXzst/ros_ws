...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNode0>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNode0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_uwb_eskf-msg:<LinktrackNode0> is deprecated: use imu_uwb_eskf-msg:LinktrackNode0 instead.")))
...
(cl:defmethod data-val ((m <LinktrackNode0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:data-val is deprecated.  Use imu_uwb_eskf-msg:data instead.")
  (data m))
