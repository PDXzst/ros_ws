...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNode5>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNode5)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_uwb_eskf-msg:<LinktrackNode5> is deprecated: use imu_uwb_eskf-msg:LinktrackNode5 instead.")))
