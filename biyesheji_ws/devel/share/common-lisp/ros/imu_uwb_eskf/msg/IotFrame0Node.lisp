...
(cl:defmethod cl:initialize-instance :after ((m <IotFrame0Node>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IotFrame0Node)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_uwb_eskf-msg:<IotFrame0Node> is deprecated: use imu_uwb_eskf-msg:IotFrame0Node instead.")))

(cl:ensure-generic-function 'uid-val :lambda-list '(m))
(cl:defmethod uid-val ((m <IotFrame0Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:uid-val is deprecated.  Use imu_uwb_eskf-msg:uid instead.")
  (uid m))

(cl:ensure-generic-function 'dis-val :lambda-list '(m))
(cl:defmethod dis-val ((m <IotFrame0Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:dis-val is deprecated.  Use imu_uwb_eskf-msg:dis instead.")
  (dis m))

(cl:ensure-generic-function 'aoa_angle_horizontal-val :lambda-list '(m))
(cl:defmethod aoa_angle_horizontal-val ((m <IotFrame0Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:aoa_angle_horizontal-val is deprecated.  Use imu_uwb_eskf-msg:aoa_angle_horizontal instead.")
...
(cl:defmethod aoa_angle_vertical-val ((m <IotFrame0Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:aoa_angle_vertical-val is deprecated.  Use imu_uwb_eskf-msg:aoa_angle_vertical instead.")
  (aoa_angle_vertical m))

(cl:ensure-generic-function 'fp_rssi-val :lambda-list '(m))
(cl:defmethod fp_rssi-val ((m <IotFrame0Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:fp_rssi-val is deprecated.  Use imu_uwb_eskf-msg:fp_rssi instead.")
  (fp_rssi m))

(cl:ensure-generic-function 'rx_rssi-val :lambda-list '(m))
(cl:defmethod rx_rssi-val ((m <IotFrame0Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:rx_rssi-val is deprecated.  Use imu_uwb_eskf-msg:rx_rssi instead.")
  (rx_rssi m))

(cl:ensure-generic-function 'user_data-val :lambda-list '(m))
(cl:defmethod user_data-val ((m <IotFrame0Node>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:user_data-val is deprecated.  Use imu_uwb_eskf-msg:user_data instead.")
  (user_data m))
