...
(cl:defmethod cl:initialize-instance :after ((m <TofsenseFrame0>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TofsenseFrame0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_uwb_eskf-msg:<TofsenseFrame0> is deprecated: use imu_uwb_eskf-msg:TofsenseFrame0 instead.")))
...
(cl:defmethod dis_status-val ((m <TofsenseFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:dis_status-val is deprecated.  Use imu_uwb_eskf-msg:dis_status instead.")
  (dis_status m))

(cl:ensure-generic-function 'signal_strength-val :lambda-list '(m))
(cl:defmethod signal_strength-val ((m <TofsenseFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:signal_strength-val is deprecated.  Use imu_uwb_eskf-msg:signal_strength instead.")
  (signal_strength m))

(cl:ensure-generic-function 'range_precision-val :lambda-list '(m))
(cl:defmethod range_precision-val ((m <TofsenseFrame0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_uwb_eskf-msg:range_precision-val is deprecated.  Use imu_uwb_eskf-msg:range_precision instead.")
  (range_precision m))
