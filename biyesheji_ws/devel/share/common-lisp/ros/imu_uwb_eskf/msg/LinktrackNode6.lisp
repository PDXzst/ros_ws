...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNode6>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNode6)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_uwb_eskf-msg:<LinktrackNode6> is deprecated: use imu_uwb_eskf-msg:LinktrackNode6 instead.")))
