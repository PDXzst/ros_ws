...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNode2>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNode2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_uwb_eskf-msg:<LinktrackNode2> is deprecated: use imu_uwb_eskf-msg:LinktrackNode2 instead.")))
