...
"""autogenerated by genpy from imu_uwb_eskf/LinktrackNodeframe1.msg. Do not edit."""
import codecs
import sys
...
class LinktrackNodeframe1(genpy.Message):
  ...
  _type = "imu_uwb_eskf/LinktrackNodeframe1"
...
"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','imu_uwb_eskf/LinktrackNode1[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_uwb_eskf.msg.LinktrackNode1()
        _x = val1
        start = end
        end += 2
