...
"""autogenerated by genpy from imu_uwb_eskf/TofsenseCascade.msg. Do not edit."""
import codecs
import sys
...
class TofsenseCascade(genpy.Message):
  ...
  _type = "imu_uwb_eskf/TofsenseCascade"
...
"""
  __slots__ = ['nodes']
  _slot_types = ['imu_uwb_eskf/TofsenseFrame0[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_uwb_eskf.msg.TofsenseFrame0()
        _x = val1
        start = end
        end += 13
