...
"""autogenerated by genpy from imu_uwb_eskf/LinktrackAoaNodeframe0.msg. Do not edit."""
import codecs
import sys
...
class LinktrackAoaNodeframe0(genpy.Message):
  ...
  _type = "imu_uwb_eskf/LinktrackAoaNodeframe0"
...
"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','imu_uwb_eskf/LinktrackAoaNode0[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_uwb_eskf.msg.LinktrackAoaNode0()
        _x = val1
        start = end
        end += 18
