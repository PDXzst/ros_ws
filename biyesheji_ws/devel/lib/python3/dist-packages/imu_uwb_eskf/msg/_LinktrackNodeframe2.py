...
"""autogenerated by genpy from imu_uwb_eskf/LinktrackNodeframe2.msg. Do not edit."""
import codecs
import sys
...
class LinktrackNodeframe2(genpy.Message):
  ...
  _type = "imu_uwb_eskf/LinktrackNodeframe2"
...
"""
  ...
  _slot_types = ['uint8','uint8','uint32','uint32','float32','float32[3]','float32[3]','float32[3]','float32[3]','float32[4]','float32[3]','float32[3]','imu_uwb_eskf/LinktrackNode2[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_uwb_eskf.msg.LinktrackNode2()
        _x = val1
        start = end
        end += 14
