...
"""autogenerated by genpy from imu_uwb_eskf/IotFrame0.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['uint32','uint32','uint8','imu_uwb_eskf/IotFrame0Node[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = imu_uwb_eskf.msg.IotFrame0Node()
        _x = val1
        start = end
        end += 24
